...
<form id="subform" action="../SubjectServlet?mode=edt" method="post">
    <div class="titlebar"><span class="title" id="subedttitle"></span><span class="close"
                                                                            onclick="hideDialog('#subjectedt')"
                                                                            title="关闭">X</span></div>
    <div class="content">
        <table class="mtable1">
            ...
            <tr>
                ...
                <td colspan=7>指导教师&nbsp;&nbsp;<span id="tutorname" name="tutorname">&nbsp;&nbsp;<%=username%></span>
                    ...
                    其他指导教师编号&nbsp;<input type="text" id="othertid" class="text" name="othertid"
                                                 style="width:80px"/>
                    ...
                    <div class="searchwin" id="searchteacher">
                        <div class="titlebar0"><span class="title0">双击选择教师</span><span class="close0"
                                                                                             title="关闭">X</span></div>
                        <div class="content">
                            <table class="mtable2">
                                <tr>
            ...
            <tr>
                <td>课题名称</td>
                <td colspan=7><input type="text" id="subname" name="subname" class="text"/></td>
            </tr>
            <tr>
                <td>类别</td>
                <td><select id="subsort" name="subsort" style="width:80px"></select></td>
                <td>题目性质</td>
                <td><select id="subkind" name="subkind" style="width:80px"></select></td>
                <td>题目来源</td>
                <td><select id="subsource" name="subsource" style="width:80px"></select></td>
                <td>题目类型</td>
                <td><select id="subtype" name="subtype" style="width:80px"></select>&nbsp;课题地点
            ...
            <tr>
                <td align="center">设计<br/>(论文)<br/>概述<br/><span class="flagmin">[400字]</span><br/><span
                        class="flagmin"></span></td>
                <td colspan=7><textarea id="oldargu" name="oldargu" rows="10"></textarea></td>
            </tr>
            <tr>
                <td align="center">设计<br/>(论文)<br/>工作内容<br/><span class="flagmin">[400字]</span><br/><span
                        class="flagmin"></span></td>
                <td colspan=7><textarea id="workcontent" name="content" rows="10"></textarea></td>
            </tr>
            <tr>
                <td align="center">设计<br/>(论文)<br/>工作基本要求<br/><span class="flagmin">[50字]</span><br/><span
                        class="flagmin"></span></td>
                <td colspan=7><textarea id="requirement" name="requirement" rows="6"></textarea></td>
            </tr>
            <tr>
                <td align="center">设计<br/>(论文)<br/>工作日程</td>
                <td colspan=7>
                    <textarea id="subprog" name="subprog" rows="10" style="display:none"></textarea>
                    <input type="text" id="graduateweeknum" name="graduateweeknum" style="display:none"
                           value="<%=graduateweeknum %>"/>
                    <table class="mtable2" id="progresstable">
                        <tr>
                            <td width=150px align="center">时间（按两周填写）</td>
                            <td align="center">应完成的工作内容</td>
                        </tr>
                        <%
            ...
            <tr>
                <td width="8%" align="center">主要参考资料及文献</td>
                <td colspan=7><textarea id="refpapers" name="refpapers" rows="10"></textarea></td>
            </tr>
        </table>
        <hr>
        <div>
            <table class="mtable2" id="ktshzy">
                <tr>
                    ...
                    <td width=300px style="text-align:right;vertical-align:bottom;">
                        <span class="flag" id="errmsg"></span>
                        <hr>
