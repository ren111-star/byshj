<%@ page language="java" contentType="text/html;charset=utf-8" pageEncoding="utf-8" import="bpo.TeacherBpo,bean.TeacherBean,bpo.SpecialityBpo,bpo.SysarguBpo,bean.SpecialityBean" errorPage="../error.jsp" %>
<%
	//检查用户是否合法
	...
	<body>
		<div id="wrapper">
			<div id="header">
				<div class="logo">
					<div style="float:right">
						...
						<a href="../uploadfiles/help/specteacher.pdf" title="点击打开" style="color:red;font-weight:bold;font-size:14px" target="_blank">
						<%} else{%>
						<a href="../uploadfiles/help/teacher.pdf" title="点击打开" style="color:red;font-weight:bold;font-size:14px" target="_blank">
						<%}%>
						系统使用说明
						</a>
					</div>
			...
			<div id="content">
				<div id="mysubject">
					<table class="mtable2">
						<caption>我的课题列表&nbsp;&nbsp;<input type="button" value="刷新" id="mysubrefresh"/><img src="../images/loading.gif" id="loading"></img></caption>
						<tr><th>序号</th><th>课题名</th><th>指导教师</th><th>课题地点</th><th>适合专业</th><th>课题状态</th><th>操作</th></tr>
						<tbody id="tbmysubject"></tbody>
					</table>
					<br><input type="hidden" id="highlighttr" value=""/>
					<input type="button" onclick="subject_showwin('',1)" value="申报新课题"></input>&nbsp;&nbsp;您目前课题数为<span id="currsubnum"></span>，最多可以申报<span id="maxsubnum"></span>个课题。
					&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div id="viewdesign" class="win">
        				...
        				<div class="content"> 
        					<table class="mtable2">
        						<tbody id="tbdesign">
        						    <tr name="paperblind"><td>1</td><td><a href="#">毕业设计说明书(论文)[盲审]</a></td><td></td><td></td></tr>
        							<tr name="paper"><td>2</td><td><a href="#">毕业设计说明书(论文)</a></td><td></td><td></td></tr>
        							<tr name="translation"><td>3</td><td><a href="#">外文文献及翻译<a href="#"></td><td></td><td></td></tr>
        							<tr name="sourcecode"><td>4</td><td><a href="#">程序源代码（开题报告）<a href="#"></td><td></td><td></td></tr>
        						</tbody>
        					</table>
        				</div>
					</div>
